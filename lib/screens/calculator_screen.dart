...
class _HomeScreenState extends State<HomeScreen> {
  ...
  static const Color buttonAdditionalBgColor = Color(0xFF212121);
  ...
  Widget build(BuildContext context) {
    ...
    List<Widget> landscapeButtonListRow1 = _isLandscape()
        ? <Widget>[
            _actionButtonWidget(
                '(', _textWidget('(', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                ')', _textWidget(')', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'mc', _textWidget('mc', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'm+', _textWidget('m+', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'm-', _textWidget('m-', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'mr',
    ...
    List<Widget> landscapeButtonListRow3 = _isLandscape()
        ? <Widget>[
            _actionButtonWidget(
                '1/x', _textWidget('1/x', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'sqrt[2]{x}',
    ...
    List<Widget> landscapeButtonListRow4 = _isLandscape()
        ? <Widget>[
            _actionButtonWidget(
                'x!', _textWidget('x!', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'sin', _textWidget('sin', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'cos', _textWidget('cos', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'tan', _textWidget('tan', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'e', _textWidget('e', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'EE', _textWidget('EE', textStyle), buttonAdditionalBgColor),
          ]
        : <Widget>[];
    ...
    List<Widget> landscapeButtonListRow5 = _isLandscape()
        ? <Widget>[
            _actionButtonWidget(
                ...
                buttonAdditionalBgColor),
            _actionButtonWidget(
                'sinh', _textWidget('sinh', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'cosh', _textWidget('cosh', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'tanh', _textWidget('tanh', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'pi', _textWidget('\u03C0', textStyle), buttonAdditionalBgColor),
            _actionButtonWidget(
                'rand', _textWidget('Rand', textStyle), buttonAdditionalBgColor),
          ]
        : <Widget>[];
